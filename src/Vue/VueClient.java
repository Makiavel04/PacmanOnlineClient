...
public class VueClient {
    ...
    public int getIdClient() {
        return this.controleur.getIdClient();
    }

    public int getIdLobby() {
        return this.controleur.getIdLobby();
    }

    public ArrayList<ResumeLobby> getInfosLobbies() {
        return this.controleur.getListeLobbies();
    }

    public DetailsLobby getDetailsLobby() {
        return this.controleur.getDetailsLobby();
    }

    public EtatPacmanGame getEtatPacmanGame() {
        return this.controleur.getEtatPacmanGame();
    }
    ...
    public List<String> getStrategiesDisponibles(TypeAgent typeAgent) {
        return this.controleur.getStrategiesDisponible(typeAgent);
    }

    public List<String> getListeMaps() {
        return this.controleur.getListeMaps();
    }

    public BilanPartie getBilanPartie() {
        return this.controleur.getBilanPartie();
    }
    ...
    /**
     * Demande au controller d'authentifier l'utilisateur avec les informations
     * fournies.
     * 
    ...
    /**
     * Traite la réponse du controller concernant l'authentification de
     * l'utilisateur.
     * 
    ...
    /**
     * Demande au controller la liste des lobbies disponibles sur le serveur. Le
     * controller traitera la réponse et mettra à jour l'affichage en conséquence.
     */
    ...
    /**
     * Traite la réponse du controller concernant la demande de rejoindre une
     * partie.
     * 
    ...
    /**
     * Demande au controller d'ajouter un bot de type spécifié dans la partie en
     * cours.
     * 
    ...
    /**
     * Demande au controller de retirer un bot de type spécifié dans la partie en
     * cours.
     * 
    ...
    /**
     * Demande au controller de changer la stratégie d'un bot spécifique dans la
     * partie en cours.
     * 
